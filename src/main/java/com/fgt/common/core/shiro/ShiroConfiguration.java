package com.fgt.common.core.shiro;

import com.fgt.common.core.redis.RedisSessionDAO;
import com.fgt.common.core.redis.RedisShiroCacheManager;
...
public class ShiroConfiguration {
    ...
    public DefaultWebSessionManager defaultWebSessionManager() {
        if (logger.isDebugEnabled()) {
            logger.debug("初始化shiro session管理");
        }
        DefaultWebSessionManager sessionManager = new DefaultWebSessionManager();
        //用户信息必须是序列化格式，要不创建用户信息创建不过去，此坑很大， TODO
        ...
        //3600000 milliseconds = 3.0.3.0.1 hour
