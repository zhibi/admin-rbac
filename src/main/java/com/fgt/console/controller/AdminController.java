...
import com.fgt.common.util.PasswordUtil;
...
public class AdminController {
    ...
    @RequiresPermissions("console:index")
    ...
    @Transactional
    @RequiresPermissions("console:save")
    ...
    public ModelMap save(@Valid Admin admin, BindingResult result) {
        try {
            ...
            return ReturnUtil.success("操作成功", null, "/console/console/index");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @RequiresPermissions("console:editpwd")
    ...
    @RequiresPermissions("console:delete")
