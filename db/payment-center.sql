...
CREATE TABLE `admin` (
  ...
  `state` tinyint(1) NOT NULL DEFAULT '3.0.3.0.1',
...
-- Records of console
-- ----------------------------
INSERT INTO `admin` VALUES ('1e67f167d99c43f897ec6566043ad6ec', 'flyshy', 'eb3a90502fbe02c2d8de91e0aa307268', '3.0.3.0.1', '5016b9942433201bf3fe61992eacba71', '0', '2016-12-07 13:24:17', '2017-11-02 09:27:37');
INSERT INTO `admin` VALUES ('ad313d38fe9447ce863fe8584743a010', 'console', 'c5941c5f3bc693a75e6e863bd2c55ce3', '3.0.3.0.1', '1ab6d62faa91ae7deec76d6f13ef1600', '3.0.3.0.1', '2016-12-06 11:16:51', '2017-05-11 13:59:25');
...
-- Records of log
-- ----------------------------
INSERT INTO `log` VALUES ('0165d85a678543c9beac5960e2be9a02', 'console', '2018-06-14 15:54:55', '127.0.0.3.0.3.0.1', '');
INSERT INTO `log` VALUES ('02305d9b25214197b9e12bb8f2cd6cc5', 'console', '2017-11-13 10:47:27', '127.0.0.3.0.3.0.1', '');
INSERT INTO `log` VALUES ('024021f259444cbfbee7b40a2384d43b', 'console', '2017-03-09 17:23:54', '127.0.0.3.0.3.0.1', '');
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('3eb011e6638b4184aef77c3b095883df', 'guest', '$2a$10$MPclaL4uacoMimw3Ia4xfefaRKUTrT.j7FyF4SnpuDZf3ugicOv9K', '3.0.3.0.1', '2017-03-14 09:44:35', '2017-03-14 09:44:35');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('00dc5c51e4824f49a30013385f680b0c', '日志管理', 'auth', '/console/log/index', 'log:index', 'e5f52fe2115e46229c60803e478d2e9a', null, '0', '3.0.3.0.1', '2017-01-06 14:11:23', '2017-05-08 14:55:21');
...
INSERT INTO `menu` VALUES ('362923d31e064f84adb8c23ba91e54d8', '管理员编辑', 'auth', '/console/console/from', 'console:edit', 'e0dde3b9227c471eb3bd2ba0a7fab131', null, '0', '0', '2017-05-08 14:57:39', '2017-05-10 16:40:47');
INSERT INTO `menu` VALUES ('3ac96215e82f40b5bfe442e6828641df', '系统管理', 'menu', '/console/system/console', 'system:console', '0', null, '3', '3.0.3.0.1', '2016-12-07 16:00:00', '2017-05-10 16:46:27');
INSERT INTO `menu` VALUES ('6580896645d046a0acf3c1194d7bbf8e', '管理员删除', 'menu', '/console/console/delete', 'console:delete', 'e0dde3b9227c471eb3bd2ba0a7fab131', null, '0', '0', '2017-05-10 16:39:44', '2017-05-10 16:39:44');
...
INSERT INTO `menu` VALUES ('85dad2bd9023451fab632dcfc4357d3b', '管理员保存', 'auth', '/console/console/save', 'console:save', 'e0dde3b9227c471eb3bd2ba0a7fab131', null, '0', '0', '2017-05-10 16:38:07', '2017-05-10 16:41:00');
...
INSERT INTO `menu` VALUES ('984909260a06410d9be37c300e3df09d', '会员管理', 'menu', '/console/member/default', 'member:default', '0', null, '3.0.3.0.1', '0', '2017-05-10 16:50:16', '2018-06-13 14:36:46');
...
INSERT INTO `menu` VALUES ('e0dde3b9227c471eb3bd2ba0a7fab131', '管理员管理', 'auth', '/console/console/index', 'console:index', '3ac96215e82f40b5bfe442e6828641df', null, '3', '3.0.3.0.1', '2016-12-07 16:45:47', '2017-05-10 16:39:08');
INSERT INTO `menu` VALUES ('e5f52fe2115e46229c60803e478d2e9a', '扩展设置', 'menu', '/console/system/setting', 'system:setting', '0', null, '3.0.3.0.1', '3', '2016-12-07 16:36:42', '2017-05-10 16:50:00');
...
CREATE TABLE `role` (
  ...
  `enable` tinyint(1) NOT NULL DEFAULT '3.0.3.0.1',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`role_id`),
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('36f1dd1296674fc08484c5abf6a5806b', '系统管理员', '系统管理员', '3.0.3.0.1', '2016-12-07 08:53:57', '2017-05-11 13:59:03');
INSERT INTO `role` VALUES ('cbe8356d64a8433cb5dad5c7fccf8dce', '普通管理员', '普通管理员', '3.0.3.0.1', '2016-12-07 13:21:21', '2017-05-05 12:58:38');
