...
INSERT INTO `admin` VALUES ('6222fc35aa9f43fd8f752cf50938b914', '2', '6643b025872168b199309a07789cc4cd', '1', '26f00077a39765cefb1c0eb7b0043f7f', '0', '2019-03-22 16:22:42', '2019-03-22 16:36:01');
...
INSERT INTO `log` VALUES ('080316deca174a5ea21b4529663e7c75', 'admin', '2019-03-22 12:53:39', '127.0.0.1', '');
INSERT INTO `log` VALUES ('362570545cb44213acd298a8dc466468', 'admin', '2019-03-22 16:28:13', '127.0.0.1', '');
INSERT INTO `log` VALUES ('4bd963addbec4168a1a161db2208ce27', 'admin', '2019-03-22 16:22:42', '127.0.0.1', '');
INSERT INTO `log` VALUES ('50c5741713894a8183442738652c0340', 'admin', '2019-03-22 14:52:58', '127.0.0.1', '');
INSERT INTO `log` VALUES ('5f341a701d7d455ead33755804f884fd', 'admin', '2019-03-22 10:50:03', '127.0.0.1', '');
INSERT INTO `log` VALUES ('78404a4024c24b6299cade502c4b5d15', 'admin', '2019-03-22 16:36:01', '127.0.0.1', '');
INSERT INTO `log` VALUES ('816a0b242e5241649ea7116494535cb3', 'admin', '2019-03-22 13:52:48', '127.0.0.1', '');
INSERT INTO `log` VALUES ('859783014d3c44939884faec3185ec8f', 'admin', '2019-03-22 14:12:22', '127.0.0.1', '');
INSERT INTO `log` VALUES ('96388653c3df481186e40cc69c7cc3a0', 'admin', '2019-03-22 11:18:58', '127.0.0.1', '');
INSERT INTO `log` VALUES ('a19b12f3862c4a1bb00d5dfb384760fd', 'admin', '2019-03-22 11:37:27', '127.0.0.1', '');
INSERT INTO `log` VALUES ('c4bb8029834f4483ac822bfd5eb11a27', 'admin', '2019-03-22 13:20:13', '127.0.0.1', '');
INSERT INTO `log` VALUES ('c4ea4b07350a497f9565c7418863c371', 'admin', '2019-03-22 12:37:21', '127.0.0.1', '');
INSERT INTO `log` VALUES ('d5e48c129b6948d08fd4f167e70afacc', 'admin', '2019-03-22 16:18:43', '127.0.0.1', '');
INSERT INTO `log` VALUES ('d5e9edb1bd844e8597c589cd2a3db9e3', 'admin', '2019-03-22 13:17:36', '127.0.0.1', '');
INSERT INTO `log` VALUES ('dbd45c7921bd46cda2a7ea27cc4af9aa', 'admin', '2019-03-22 13:29:00', '127.0.0.1', '');
INSERT INTO `log` VALUES ('dcce3de49a2848588f7eb84e098ef2ea', 'admin', '2019-03-22 13:44:23', '127.0.0.1', '');
INSERT INTO `log` VALUES ('def9ff39a10b43b6bc36bff8bd59eff1', 'admin', '2019-03-22 12:43:02', '127.0.0.1', '');
INSERT INTO `log` VALUES ('e3023cf5c736409785ce5746dd71aeb4', 'admin', '2019-03-22 14:10:07', '127.0.0.1', '');
INSERT INTO `log` VALUES ('f404609f37574a5f99ce55138fe1086e', 'admin', '2019-03-22 16:36:01', '127.0.0.1', '');
INSERT INTO `log` VALUES ('fa96db6ea97b44b4b664c414cae5ce1a', 'admin', '2019-03-22 16:09:44', '127.0.0.1', '');
INSERT INTO `log` VALUES ('ffac4c6b49684916b47a5fb5892e4405', 'admin', '2019-03-22 14:14:23', '127.0.0.1', '');
...
INSERT INTO `menu` VALUES ('362923d31e064f84adb8c23ba91e54d8', '管理员编辑', 'auth', '/console/admin/from', 'console:edit', 'e0dde3b9227c471eb3bd2ba0a7fab131', null, '0', '0', '2017-05-08 14:57:39', '2017-05-10 16:40:47');
...
INSERT INTO `menu` VALUES ('6580896645d046a0acf3c1194d7bbf8e', '管理员删除', 'menu', '/console/admin/delete', 'console:delete', 'e0dde3b9227c471eb3bd2ba0a7fab131', null, '0', '0', '2017-05-10 16:39:44', '2017-05-10 16:39:44');
...
INSERT INTO `menu` VALUES ('85dad2bd9023451fab632dcfc4357d3b', '管理员保存', 'auth', '/console/admin/save', 'console:save', 'e0dde3b9227c471eb3bd2ba0a7fab131', null, '0', '0', '2017-05-10 16:38:07', '2017-05-10 16:41:00');
...
INSERT INTO `menu` VALUES ('e0dde3b9227c471eb3bd2ba0a7fab131', '管理员管理', 'auth', '/console/admin/index', 'console:index', '3ac96215e82f40b5bfe442e6828641df', null, '3', '1', '2016-12-07 16:45:47', '2017-05-10 16:39:08');
